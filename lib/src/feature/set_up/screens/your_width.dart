...
class YourWidth extends StatefulWidget {
  const YourWidth({super.key});

  @override
  State<YourWidth> createState() => _YourWidthState();
}

class _YourWidthState extends State<YourWidth> {
      ...
      body: Column(
        children: [
          ...
          RulerPicker(
            ...
            rulerScaleTextStyle: context.customTextStyle(fontSize: 20, color: AppColors.white, ),
          ...
          SizedBox(height: 40),
SvgPicture.asset('assets/icons/trivniz.svg'),
          SizedBox(height: 10),
          Text(
            ...
            BlurBotton(
              ...
              onPressed: () {
                  context.read<SetUpCubit>().collectInfo(key: 'width', value: currentValue );
            
                  Navigator.pushNamed(context, AppPages.yourheight);
